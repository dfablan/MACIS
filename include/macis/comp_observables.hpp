...
// auto comp_observables(void* params, bool db_occs_flag, bool sz_sz_flag, bool
// tz_tz_flag){
...
//                      rank4_span<double>(trdm_ud, n_imp, n_imp, n_imp, n_imp),
//                      rank4_span<double>(trdm_dd, n_imp, n_imp, n_imp,
//                      n_imp));
...
//        }
//       orb_db_occs = orb_db_occs/n_imp;
//        std::cout << "Double Occupancies (from 2-RDM) = " <<
//        std::setprecision(10) << orb_db_occs << std::endl;
//    }
...
//               sz_sz[site_i + site_j*n_sites] += 0.25*(trdm_uu[a + a * n_imp +
//               b * n_imp2 + b * n_imp3]
//                                                  - trdm_ud[a + a * n_imp + b
//                                                  * n_imp2 + b * n_imp3]
//                                                  - trdm_du[a + a * n_imp + b
...
//       // for (size_t site_i = 0; site_i < n_sites; site_i
//       //     for (size_t site_j = 0; site_j < n_sites; site_j++)
//       //         ofs << site_i << " " << site_j << " " << sz[site_i +
//       site_j*n_sites] << std::endl;
//       // ofs.close();
//   } // close sz_sz_flag
...
//               else sign = -1.0;
//               tz_tz[site_i + site_j*n_sites] += 0.25*( sign * trdm_uu[a + a *
//               n_imp + b * n_imp2 + b * n_imp3]
//                                                  +     sign * trdm_ud[a + a *
//                                                  n_imp + b * n_imp2 + b *
//                                                  n_imp3]
//                                                  +     sign * trdm_du[a + a *
        ...
        for(size_t band_i = 0; band_i < n_bands_; band_i++) {
          for(size_t band_j = 0; band_j < n_bands_; band_j++) {
            ...
            sz_sz[site_i + site_j * n_sites_] +=
                0.25 * (trdm_uu_[a + a * n_imp_ + b * n_imp2_ + b * n_imp3_] -
