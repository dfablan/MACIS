...
if(testGF) {
  ...
  std::cout << "GF_orbs_basis[" << i << "] = " << gf_settings.GF_orbs_basis[i] << std::endl;
  for(int i = 0; i < n_imp; i++)
  std::cout << "GF_orbs_comp[" << i << "] = " << gf_settings.GF_orbs_comp[i] << std::endl;
  for(int i = 0; i < n_imp; i++)
  std::cout << "is_up_basis[" << i << "] = " << gf_settings.is_up_basis[i] << std::endl;
  for(int i = 0; i < n_imp; i++)
  std::cout << "is_up_comp[" << i << "] = " << gf_settings.is_up_comp[i] << std::endl;
